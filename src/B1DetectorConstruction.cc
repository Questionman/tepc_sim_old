...
*/
  ...
  G4Box* solidRegolith = new G4Box("Regolith", 0.499*world_size, 0.499*world_size, 0.5*regolith_depth);
  ...
  //------------------------------------------------------
  //Atmosphere
  G4Sphere* solidAtmosphere = new G4Sphere("Atmosphere", 6.980001*cm, 0.499*world_size, 0, 360*degree, 0, 90*degree);
